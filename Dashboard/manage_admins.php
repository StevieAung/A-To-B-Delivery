<?php
// filepath: /Applications/XAMPP/xamppfiles/htdocs/Delivery/Dashboard/manage_admins.php
session_start();
...
if ($adminRole !== 'super_admin') {
    header("Location: dashboard.php"); // Redirect to dashboard if not a super admin
    exit;
}
    ...
    <div class="row">
        ...
        <nav class="col-md-3 col-lg-2 d-md-block sidebar">
            ...
            <?php if ($adminRole === 'super_admin'): ?>
                <a href="manage_admins.php" class="active"><i class="fas fa-user-shield"></i> Manage Admins</a>
            <?php endif; ?>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <?php if ($admins->num_rows > 0): ?>
                                ...
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr><td colspan="5" class="text-muted text-center">No admins found</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
